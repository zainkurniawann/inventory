...
<head>
    ...
    <link rel="shortcut icon" href="https://i.pinimg.com/564x/1f/c8/f7/1fc8f7f2bfcf51f0b019161522a8182a.jpg" type="image/x-icon">
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">NaufalCoding</div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://i.pinimg.com/564x/cc/36/cc/cc36cc2392a591ff619a5e08c1d3cbf3.jpg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span id="copyrihgt">Copyright &copy; Naufal Hafizh</span>
                        <!-- <div ></div> -->
                    </div>
                </div>
            </footer>
